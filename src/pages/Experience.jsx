...
const experiences = [
  {
    ...
    company: "Web Devers",
    duration: "2023",
    description: "Worked on self projects, integrated third party API and build projects like weather APP, Language Translator, Currency Converter ETC.",
  },
  {
    role: "Full-Stack Developer",
    company: "Shell Shift",
    duration: "2025",
    description: "Self Projects listed in resume , projects like E-Commerce website , Food website, Blog Website, News Website ETC.",
  },
  {
    role: "UI/UX developer",
    company: "Shell Shift",
    duration: "2022",
    description: "Successfully translated Figma designs into pixel-perfect, responsive code with a strong focus on animations and clean UI architecture.",
  },
];
  ...
  return (
    <section id='experience' className='relative bg-black text-white'>
      <div ref={sceneRef} style={{ height: `${scene_height_VH}vh`, minHeight: "120vh" }} className='relative'>
        <div className={`sticky top-0 h-screen flex flex-col ${isMobile ? 'justify-start pt-10' : 'justify-center'}`}>
