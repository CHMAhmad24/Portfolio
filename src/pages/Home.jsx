...
export default function Home() {
  ...
  const roles = useMemo(() => ["Full Stack Developer", "FrontEnd Developer"], [])
    ...
    <section id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      <div className='absolute inset-0'>
        <div className='absolute -top-32 -left-32 
          ...
          max-w-125 max-h-125
          rounded-full 
          bg-linear-to-r from-[#b02b63] via-[#00bf8f] to-[#1cd8d2]
        ...
        <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
          <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
            <div className='w-full lg:pr-24 mx-auto max-w-3xl'>
              ...
              >
                ...
                <span className='inline-block w-0.5 ml-1 bg-white animate-pulse align-middle h-[1em]'></span>
              </motion.div>
              <motion.h1 className='text-4xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg'
                initial={{ opacity: 0, y: 40 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1 }}
              >Hello, I'm <br />
                <span className='text-white font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl lg:whitespace-nowrap'>Ch M Ahmad</span>
              </motion.h1>
          ...
          <div className='relative hidden lg:block'>
            <div className='absolute top-1/2 -translate-y-1/2 pointer-events-none'
              style={{
                right: "10px", width: "min(44vw, 410px)", height: "min(80vh, 760px)", borderRadius: "50%",
                filter: "blur(38px)", opacity: 0.32, background: "conic-gradient(from 0deg, #1cd8d2, #00bd8f, #302b63, #1cd8d2)"
              }}
            />
            <motion.img src={avator} alt="CH M Ahmad" className='absolute top-1/2 -translate-y-1/2 object-contain select-none pointer-events-none'
              style={{
