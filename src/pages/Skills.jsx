...
import { SiAngular, SiCloudinary, SiDocker, SiFastapi, SiMongodb, SiPython, SiTailwindcss, SiTypescript } from 'react-icons/si';
  ...
  return (
    <section id='skills' ref={sectionRef} className='h-1/2 w-full pb-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden'>
      <div className='absolute inset-0 pointer-events-none'>
        <div className='absolute top-1/4 left-0 w-75 h-75 rounded-full bg-linear-to-r from-[#302b63] via-[#00df8f] to-[#1cd8d2] opacity-20 blur-[120px] animate-pulse' />
        <div className='absolute bottom-1/4 right-0 w-75 h-75 rounded-full bg-linear-to-r from-[#302b63] via-[#00df8f] to-[#1cd8d2] opacity-20 blur-[120px] animate-pulse delay-500' />
      </div>
