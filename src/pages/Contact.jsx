...
export default function Contact() {
  ...
  const validateForm = () => {
    const reqired = ["name", "email", "service", "idea"];
    const newErrors = {};
    reqired.forEach((f) => !formData[f].trim() && (newErrors[f] = "Fill this field"));
    ...
    <section id='contact' className='w-full min-h-screen relative bg-black overflow-hidden text-white py-20 px-6 md:px-20 flex flex-col md:flex-row items-center gap-10'>
      ...
      <div className='relative z-10 w-full flex flex-col md:flex-row items-center gap-10'>
        <motion.div className='w-full md:w-1/2 flex justify-center'
          ...
          <motion.img src={Astra} alt="Astronaut" className='w-72 md:w-140 rounded-2xl shadow-lg object-cover select-none pointer-events-none'
            animate={{ y: [0, -10, 0] }}
        ...
        <motion.div className='w-full md:w-1/2 bg-white/5 p-8 rounded-2xl shadow-lg border border-white/10'
          ...
          <form className='flex flex-col gap-5' onSubmit={handleSubmit}>
            <div className='flex flex-col'>
              ...
              <input type="text" name="name" value={formData.name} placeholder='Your Name' onChange={handleChange} className={`p-3 rounded-md bg-white/10 border 
            ...
            <div className='flex flex-col'>
              ...
              <input type="text" name="email" placeholder='Your Email' value={formData.email} onChange={handleChange} className={`p-3 rounded-md bg-white/10 border 
            ...
            <div className='flex flex-col'>
              ...
              <select name="service" value={formData.service} onChange={handleChange} className={`p-3 rounded-md bg-white/10 border cursor-pointer
                ...
                <option value="Web Development" className='text-black cursor-pointer'>Web Development</option>
                <option value="Mobile Application" className='text-black cursor-pointer'>Mobile Application</option>
            ...
            {formData.service && formData.service !== "other" && (
              <div className='flex flex-col'>
                ...
                <input type="text" name='budget' placeholder='Your Budget' onChange={handleChange} value={formData.budget} className={`p-3 rounded-md bg-white/10 border 
            ...
            <motion.button className='bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white py-3 rounded-md font-semibold transition cursor-pointer'
